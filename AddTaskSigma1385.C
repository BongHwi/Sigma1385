AliAnalysisTaskSigma1385temp* AddTaskSigma1385(const char *taskname = "Sigma1385"
                                     ...
                                     , const char* suffix = "MB")
{
    ...
    if(foption.Contains("Mix")){
        ...
        std::cout << "AliAnalysisTaskSigma1385temp:: Event Mix(" << nmix << ") mode " << std::endl;
    } 
    if(foption.Contains("HM")){
        taskSigma1385->fEventCuts.fTriggerMask =
            AliVEvent::kHighMultV0;  // default: kINT7
        std::cout << "AliAnalysisTaskSigma1385temp:: HighMultV0 mode " << std::endl;
    }  
    if(foption.Contains("Study")){
        taskSigma1385->SetCutOpen();
        taskSigma1385->SetFillnTuple(true);
        std::cout << "AliAnalysisTaskSigma1385temp:: Cut Study mode " << std::endl;
    }  
