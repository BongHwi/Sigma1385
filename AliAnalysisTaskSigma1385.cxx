...
class AliAnalysisTaskSigma1385;

ClassImp(AliAnalysisTaskSigma1385) // classimp: necessary for root
...
AliAnalysisTaskSigma1385::AliAnalysisTaskSigma1385(const char* name, Bool_t MCcase) : 
...
void AliAnalysisTaskSigma1385::SetCutOpen() {
    // Pion cuts
...
//_____________________________________________________________________________
Bool_t AliAnalysisTaskSigma1385::GoodTracksSelection() {
...
Bool_t AliAnalysisTaskSigma1385::GoodV0Selection() {
...
void AliAnalysisTaskSigma1385::FillTracks() {
    AliVTrack* track1;
    AliESDv0* v0ESD;
    AliAODv0* v0AOD;
...
void AliAnalysisTaskSigma1385::FillNtuples() {
...
Bool_t AliAnalysisTaskSigma1385::IsTrueSigmaStar(UInt_t v0Index, UInt_t pionIndex){
...
THnSparse* AliAnalysisTaskSigma1385::CreateTHnSparse(TString name,
                                                      TString title,
                                                      Int_t ndim,
...
Long64_t AliAnalysisTaskSigma1385::FillTHnSparse(TString name,
...
Long64_t AliAnalysisTaskSigma1385::FillTHnSparse(THnSparse* h,
                                                  std::vector<Double_t> x,
                                                  Double_t w) {
    // From AliPhysics/PWGUD/DIFFRACTIVE/Resonance/AliAnalysisTaskf0f2.cxx
    // Original author: Beomkyu Kim
...
TAxis AliAnalysisTaskSigma1385::AxisFix(TString name,
                                         int nbin,
                                         Double_t xmin,
                                         Double_t xmax) {
    // From AliPhysics/PWGUD/DIFFRACTIVE/Resonance/AliAnalysisTaskf0f2.cxx
...
TAxis AliAnalysisTaskSigma1385::AxisStr(TString name,
...
TAxis AliAnalysisTaskSigma1385::AxisVar(TString name,
...
double AliAnalysisTaskSigma1385::GetTPCnSigma(AliVTrack* track,
...
void AliAnalysisTaskSigma1385::FillTrackToEventPool() {
