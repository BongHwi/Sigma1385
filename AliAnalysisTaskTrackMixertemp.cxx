...
class AliAnalysisTaskTrackMixertemp;

ClassImp(AliAnalysisTaskTrackMixertemp)
    AliAnalysisTaskTrackMixertemp::AliAnalysisTaskTrackMixertemp()
    : AliAnalysisTaskSE(),
      fTrackCuts(nullptr),
      fEventCuts(),
      fCheckTPCGeo(kFALSE),
...
AliAnalysisTaskTrackMixertemp::AliAnalysisTaskTrackMixertemp(const char* name)
...
AliAnalysisTaskTrackMixertemp::~AliAnalysisTaskTrackMixertemp() {}
//_____________________________________________________________________________
void AliAnalysisTaskTrackMixertemp::UserCreateOutputObjects() {
...
//_____________________________________________________________________________
void AliAnalysisTaskTrackMixertemp::UserExec(Option_t*) {
...
//_____________________________________________________________________________
void AliAnalysisTaskTrackMixertemp::Terminate(Option_t*) {}
//_____________________________________________________________________________
void AliAnalysisTaskTrackMixertemp::GoodTracksSelection() {
...
void AliAnalysisTaskTrackMixertemp::FillTrackToEventPool() {
...
TAxis AliAnalysisTaskTrackMixertemp::AxisFix(TString name,
                                             int nbin,
                                             Double_t xmin,
                                             Double_t xmax) {
...
TAxis AliAnalysisTaskTrackMixertemp::AxisVar(TString name,
...
double AliAnalysisTaskTrackMixertemp::GetTPCnSigma(AliVTrack* track,
...
void AliAnalysisTaskTrackMixertemp::GetImpactParam(AliVTrack* track,
                                                   Float_t p[2],
                                                   Float_t cov[3]) {
  AliNanoAODTrack* nanoT = dynamic_cast<AliNanoAODTrack*>(track);
  if (nanoT)
...
Bool_t AliAnalysisTaskTrackMixertemp::IsSelectedTPCGeoCut(AliAODTrack* track) {
...
Bool_t AliAnalysisTaskTrackMixertemp::IsSelectedTPCGeoCut(AliESDtrack* track) {
  Bool_t checkResult = kTRUE;
