#ifndef AliAnalysisTaskTrackMixertemp_H
#define AliAnalysisTaskTrackMixertemp_H
...
class AliAnalysisTaskTrackMixertemp : public AliAnalysisTaskSE {
 public:
  AliAnalysisTaskTrackMixertemp();
  AliAnalysisTaskTrackMixertemp(const char* name);
  virtual ~AliAnalysisTaskTrackMixertemp();
 ...
 private:
  ...
  ClassDef(AliAnalysisTaskTrackMixertemp, 1);
  // 1: First version.
};
