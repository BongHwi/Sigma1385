  ...
  const char* check    = 0)
{
  ...
  // <aDataDir>/<dir0>/AliAOD.NanoAOD.root
  // <aDataDir>/<dir1>/AliAOD.NanoAOD.root
  // ...
  //
  ...
  if (flags & 2)
  {
    ...
    for (Int_t iDir=0; iDir<nDirs; ++iDir)
    {
      ...
      chain->Add(presentDirName + "/AliAOD.NanoAOD.root/aodTree");
  ...
  else
  {
	...
	aodFile += "#AliAOD.NanoAOD.root";
      ...
      if (chainFriend) {
        ...
        friendFileName.ReplaceAll("AliAOD.NanoAOD.root", friends);
